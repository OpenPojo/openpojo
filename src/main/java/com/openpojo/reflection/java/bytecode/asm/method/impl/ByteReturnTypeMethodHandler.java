 ...
 * @author oshoukry
 */
public class ByteReturnTypeMethodHandler extends AbstractReturnTypeMethodHandler {
  private static final Type HANDLER_TYPE = Type.getObjectType(Byte.class.getName());
  private static final int OPCODE = Opcodes.IRETURN;
  private static final String asPrimitiveMethod = "byteValue";
  private static final String RETURN_DESCRIPTION = "()B";
