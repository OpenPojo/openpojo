 ...
 * @author oshoukry
 */
public class CharReturnTypeMethodHandler extends AbstractReturnTypeMethodHandler {
  private static final Type HANDLER_TYPE = Type.getObjectType(Character.class.getName());
  private static final int OPCODE = Opcodes.IRETURN;
  private static final String asPrimitiveMethod = "charValue";
  private static final String RETURN_DESCRIPTION = "()C";
