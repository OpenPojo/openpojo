 ...
 * @author oshoukry
 */
public class CredentialsRandomGeneratorTest extends AbstractGeneratorTest {

  protected PojoClass getPojoClass() {
    return PojoClassFactory.getPojoClass(CredentialsRandomGenerator.class);
  }
  ...
  protected RandomGenerator getRandomGenerator() {
    return CredentialsRandomGenerator.getInstance();
  }
}