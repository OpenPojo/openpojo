...
public class JARPackageLoaderTest {
    ...
    private final String[] expectedClassesNames = new String[]{ "org.apache.log4j.Appender",
            ...
            "org.apache.log4j.BasicConfigurator", "org.apache.log4j.Category", "org.apache.log4j.CategoryKey",
            "org.apache.log4j.ConsoleAppender$SystemErrStream", "org.apache.log4j.ConsoleAppender$SystemOutStream",
            "org.apache.log4j.ConsoleAppender", "org.apache.log4j.DailyRollingFileAppender",
            "org.apache.log4j.DefaultCategoryFactory", "org.apache.log4j.DefaultThrowableRenderer",
            "org.apache.log4j.Dispatcher", "org.apache.log4j.EnhancedPatternLayout",
            "org.apache.log4j.EnhancedThrowableRenderer", "org.apache.log4j.FileAppender",
            "org.apache.log4j.HTMLLayout", "org.apache.log4j.Hierarchy", "org.apache.log4j.Layout",
            "org.apache.log4j.Level", "org.apache.log4j.LogMF", "org.apache.log4j.LogManager",
            "org.apache.log4j.LogSF", "org.apache.log4j.LogXF", "org.apache.log4j.Logger", "org.apache.log4j.MDC",
            "org.apache.log4j.NDC$DiagnosticContext", "org.apache.log4j.NDC", "org.apache.log4j.NameValue",
            "org.apache.log4j.PatternLayout", "org.apache.log4j.Priority", "org.apache.log4j.PropertyConfigurator",
            "org.apache.log4j.PropertyWatchdog", "org.apache.log4j.ProvisionNode", "org.apache.log4j.RollingCalendar",
    ...
    public final void shouldGetJarSubPackages() {
        ...
        Affirm.affirmEquals(MessageFormatter.format("SubPackages added/removed to {0} found[{1}]?!", packageName,
            subPackagesNames), expectedSubPackagesNames.length, subPackagesNames.size());
    ...
    public final void shouldGetJarSubClasses() {
        ...
        Affirm.affirmEquals(MessageFormatter.format("Classes added/removed to {0} found[{1}]?!", packageName,
            classesNames), expectedClassesNames.length, classesNames.size());

        for (String expectedClassName : classesNames) {
            Affirm.affirmTrue(MessageFormatter.format("Expected class[{0}] not found", expectedClassName), classesNames
    ...
    private JARPackageLoader getJarPackageLoader(final String packageName) {
        ...
        try {
            resources = Thread.currentThread().getContextClassLoader().getResources(
                packageName.replace(PackageLoader.JDKPACKAGE_DELIMETER, PackageLoader.JDKPATH_DELIMETER));
        } catch (IOException e) {
        ...
        Affirm.affirmEquals(MessageFormatter.format("[{0}] not located in a jar file!!", packageName), "jar", resource
            .getProtocol());
