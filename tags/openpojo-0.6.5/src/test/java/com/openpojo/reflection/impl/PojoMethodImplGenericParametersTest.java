...
public class PojoMethodImplGenericParametersTest {
    ...
    public void shouldGetConstructorWithGenericParameter() {
        ...
        Affirm.affirmEquals(pojoClass.getName() + " should have only one generic parameterized constructor", 1,
                constructors.size());
    ...
    private void shouldHaveOneParameterizedParameter(List<PojoMethod> methods, Class expectedParameter) {
        ...
        Affirm.affirmTrue(method.getName() + " parameter must be of type ParamaterizedType",
        ...
        Affirm.affirmEquals(method.getName() + " parameterizedType should have only one type binding", 1,
    ...
    public void shouldGetMethodWithGenericParameter() {
        ...
        Affirm.affirmEquals(pojoClass.getName() + " should have only one generic parameterized method", 1,
                methods.size());
